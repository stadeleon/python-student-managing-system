...
class AgeCalculator(QWidget):
    def __init__(self):
        ...
        name_birth_label = QLabel("Date of Birth DD/MM/YYYY:")
        ...
        grid.addWidget(calculate_button, 2, 0, 1, 2)  # set bottom size to all width
    ...
    def calculate_age(self):
        ...
        date_of_birth = self.name_birth_line_edit.text()
